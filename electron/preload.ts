...
const allowed = new Set(['state','ui-ready','logs','save-settings','login','logout','switch-account','window-minimize','window-close','retry-launcher-update','install','play','server-status','open-folder','repair','client-mods','set-client-mod','account-avatar','skins','import-skin','apply-skin','delete-skin','shaders','install-shader','select-shader','copy-diagnostics','open-link']);
